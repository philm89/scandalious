    ...
    return (
        <main className="h-screen max-h-screen">
            <div className="flex justify-between top-0 px-4">
                <h1 className="flex top-0 px-4 justify-start items-center h-16 bg-white font-bold text-2xl">Edit Item Page Option B</h1>
            </div>
            <Form>
                <div className="px-4 divide-y divide-gray-200">
                    <div>
                        <h1 className="text-md font-medium text-gray-900">Main Item</h1>
                        <div className="flex flex-col mt-2 border-t border-gray-200">
                            <div className="flex justify-between">
                                <h4 className="flex items-center mt-2 px-1 bg-white z-10 ml-2">Item Name</h4>
                                <input type="text" name="name" defaultValue={menuItem.name} className="col-span-2 border border-slate-700 pl-2 p-2 rounded mt-2 text-slate-700"></input>
                            </div>
                            <div className="flex justify-between">
                                <h4 className="flex items-center w-3/4 mt-2 px-1 bg-white z-10 ml-2">Item Price</h4>
                                <input type="number" name="unitPrice" defaultValue={menuItem.price} className="border border-slate-700 w-1/4 rounded pl-2 p-2 mt-2 text-slate-700"></input>
                            </div>
                        </div>
