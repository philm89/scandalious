...
export default function Modal({ openModal, menuItems }) {
        ...
        <main className="bg-zinc-200 opacity-100 fixed inset-0 z-50">
            <div className="flex h-screen justify-center items-center opacity-100">
                <div className="flex-col justify-center  bg-white py-10 px-10 border-4 border-sky-500 rounded-xl">
                    ...
                    <Form className="pb-4">
                        <div>Item Name</div>
                        <input type="text" name="name" defaultValue={menuItems.name} className="border-4 border-sky-500"></input>
                        <div>Item Amount</div>
                        <input type="text" name="amount" defaultValue={menuItems.amount} className="border-4 border-sky-500"></input>
                    </Form>
